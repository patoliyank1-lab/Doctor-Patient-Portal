  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      ...
      <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-sm">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-6 px-4 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/auth/login"
              className="hidden rounded-lg px-4 py-2 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors sm:block"
            >
              Sign in
            </Link>
            <Link
              href="/auth/register"
              className="flex items-center gap-1.5 rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-white hover:bg-primary/90 transition-all active:scale-[0.98]"
            >
              Get Started
      ...
      <main>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mb-14 text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
                MediConnect brings together all the tools patients and doctors
                need into a single, beautifully designed platform.
              </p>
            </div>
        ...
        <section
          id="how-it-works"
          className="bg-muted/40 px-4 py-20 sm:px-6 sm:py-24"
        >
        ...
        <section id="testimonials" className="px-4 py-20 sm:px-6 sm:py-24">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              {TESTIMONIALS.map(
                ({ name, role, rating, text, initials, bg }) => (
                  <div
                    key={name}
